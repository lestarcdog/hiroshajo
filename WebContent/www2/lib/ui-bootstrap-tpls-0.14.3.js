...
.directive('uibAccordionTransclude', function() {
  return {
    ...
    link: function(scope, element, attrs, controller) {
      controller = controller[0] ? controller[0] : controller[1]; // Delete
																	// after we
																	// remove
																	// deprecation
...
angular.module('ui.bootstrap.accordion')
  ...
  .directive('accordionGroup', ['$log', '$accordionSuppressWarning', function($log, $accordionSuppressWarning) {
    return {
      require: '^accordion',         // We need this directive to be inside
										// an accordion
      restrict: 'EA',
      transclude: true,              // It transcludes the contents of the
										// directive into the template
 ...
 * @restrict EA
 * 
 * @description Carousel is the outer container for a set of image 'slides' to
 *              showcase.
 * 
 * @param {number=}
 *            interval The time, in milliseconds, that it will take the carousel
 *            to go to the next slide.
 * @param {boolean=}
 *            noTransition Whether to disable transitions on the carousel.
 * @param {boolean=}
 *            noPause Whether to disable pausing on the carousel (by default,
 *            the carousel interval pauses on hover).
 * 
 * @example <example module="ui.bootstrap"> <file name="index.html">
 *          <uib-carousel> <uib-slide> <img src="http://placekitten.com/150/150"
 *          style="margin:auto;"> <div class="carousel-caption">
 *          <p>
 *          Beautiful!
 *          </p>
 *          </div> </uib-slide> <uib-slide> <img
 *          src="http://placekitten.com/100/150" style="margin:auto;"> <div
 *          class="carousel-caption">
 *          <p>
 *          D'aww!
 *          </p>
 *          </div> </uib-slide> </uib-carousel> </file> <file name="demo.css">
 *          .carousel-indicators { top: auto; bottom: 15px; } </file> </example>
 */
 ...
 * @restrict EA
 * 
 * @description Creates a slide inside a
 *              {@link ui.bootstrap.carousel.directive:carousel carousel}. Must
 *              be placed as a child of a carousel element.
 * 
 * @param {boolean=}
 *            active Model binding, whether or not this slide is currently
 *            active.
 * @param {number=}
 *            index The index of the slide. The slides will be sorted by this
 *            parameter.
 * 
 * @example <example module="ui.bootstrap"> <file name="index.html"> <div
 *          ng-controller="CarouselDemoCtrl"> <uib-carousel> <uib-slide
 *          ng-repeat="slide in slides" active="slide.active" index="$index">
 *          <img ng-src="{{slide.image}}" style="margin:auto;"> <div
 *          class="carousel-caption">
 *          <h4>Slide {{$index}}</h4>
 *          <p>
 *          {{slide.text}}
 *          </p>
 *          </div> </uib-slide> </uib-carousel> Interval, in milliseconds:
 *          <input type="number" ng-model="myInterval"> <br />
 *          Enter a negative number to stop the interval. </div> </file> <file
 *          name="script.js"> function CarouselDemoCtrl($scope) {
 *          $scope.myInterval = 5000; } </file> <file name="demo.css">
 *          .carousel-indicators { top: auto; bottom: 15px; } </file> </example>
 */
...
function(scope, element, attrs, $compile, $parse, $document, $rootScope, $position, dateFilter, dateParser, datepickerPopupConfig, $timeout) {
  ...
  scope.dateSelection = function(dt) {
    ...
    var date = scope.date ? dateFilter(scope.date, dateFormat) : null; // Setting
																		// to
																		// NULL
																		// is
																		// necessary
  ...
  function($modalStack ,  $q ,  $animate,   $injector) {
    ...
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        // Observe function will be called on next digest cycle after
		// compilation, ensuring that the DOM is ready.
        // In order to use this way of finding whether DOM is ready, we need to
		// observe a scope property used in modal's template.
        ...
        modalRenderDeferObj.promise.then(function() {
          ...
          $q.when(animationPromise).then(function() {
			 ...
			 * elements with the autofocus attribute to lose focus. This is an
			 * issue on touch based devices which will show and then hide the
			 * onscreen keyboard. Attempts to refocus the autofocus element via
			 * JavaScript will not reopen the onscreen keyboard. Fixed by
			 * updated the focusing logic to only autofocus the modal element if
			 * the modal does not contain an autofocus element.
			 */
    ...
    function($modalStack ,  $q ,  $animate,   $injector, $log, $modalSuppressWarning) {
      ...
      return {
        ...
        link: function(scope, element, attrs) {
          ...
          // This property is only added to the scope for the purpose of
			// detecting when this directive is rendered.
          // We can detect that by using this property in the template
			// associated with this directive and then use
          // {@link Attribute#$observe} on it. For more details please see
			// {@link TableColumnResize}.
          scope.$isRendered = true;
          ...
          // Observe function will be called on next digest cycle after
			// compilation, ensuring that the DOM is ready.
          // In order to use this way of finding whether DOM is ready, we need
			// to observe a scope property used in modal's template.
          attrs.$observe('modalRender', function(value) {
            if (value == 'true') {
              modalRenderDeferObj.resolve();
            }
          ...
          return function link(scope, element, attrs, tooltipCtrl) {
            ...
            function hide() {
              ...
              ttScope.$evalAsync(function() {
                ...
                // FIXME: this is a placeholder for a port of the transitions
				// library.
            ...
            /**
			 * Set the inital scope values. Once the tooltip is created, the
			 * observers will be added to keep things in synch.
			 */
            ...
            function prepTriggers() {
              ...
              if (triggers.show !== 'none') {
                triggers.show.forEach(function(trigger, idx) {
                  // Using raw addEventListener due to jqLite/jQuery bug -
					// #4060
            ...
            // location change as its parent scope will probably not be
			// destroyed
            // by the change.
            if (appendToBody) {
 ...
 * 
 * @param {boolean=}
 *            vertical Whether or not to use vertical styling for the tabs.
 * @param {boolean=}
 *            justified Whether or not to use justified styling for the tabs.
 * 
 * @example <example module="ui.bootstrap"> <file name="index.html">
 *          <uib-tabset> <uib-tab heading="Tab 1"><b>First</b> Content!</uib-tab>
 *          <uib-tab heading="Tab 2"><i>Second</i> Content!</uib-tab>
 *          </uib-tabset>
 *          <hr />
 *          <uib-tabset vertical="true"> <uib-tab heading="Vertical Tab 1"><b>First</b>
 *          Vertical Content!</uib-tab> <uib-tab heading="Vertical Tab 2"><i>Second</i>
 *          Vertical Content!</uib-tab> </uib-tabset> <uib-tabset
 *          justified="true"> <uib-tab heading="Justified Tab 1"><b>First</b>
 *          Justified Content!</uib-tab> <uib-tab heading="Justified Tab 2"><i>Second</i>
 *          Justified Content!</uib-tab> </uib-tabset> </file> </example>
 */
 ...
 * 
 * @param {string=}
 *            heading The visible heading, or title, of the tab. Set HTML
 *            headings with
 *            {@link ui.bootstrap.tabs.directive:tabHeading tabHeading}.
 * @param {string=}
 *            select An expression to evaluate when the tab is selected.
 * @param {boolean=}
 *            active A binding, telling whether or not this tab is selected.
 * @param {boolean=}
 *            disabled A binding, telling whether or not this tab is disabled.
 * 
 * @description Creates a tab with a heading and content. Must be placed within
 *              a {@link ui.bootstrap.tabs.directive:tabset tabset}.
 * 
 * @example <example module="ui.bootstrap"> <file name="index.html"> <div
 *          ng-controller="TabsDemoCtrl"> <button class="btn btn-small"
 *          ng-click="items[0].active = true"> Select item 1, using active
 *          binding </button> <button class="btn btn-small"
 *          ng-click="items[1].disabled = !items[1].disabled"> Enable/disable
 *          item 2, using disabled binding </button> <br />
 *          <uib-tabset> <uib-tab heading="Tab 1">First Tab</uib-tab> <uib-tab
 *          select="alertMe()"> <uib-tab-heading><i class="icon-bell"></i>
 *          Alert me!</tab-heading> Second Tab, with alert callback and html
 *          heading! </uib-tab> <uib-tab ng-repeat="item in items"
 *          heading="{{item.title}}" disabled="item.disabled"
 *          active="item.active"> {{item.content}} </uib-tab> </uib-tabset>
 *          </div> </file> <file name="script.js"> function TabsDemoCtrl($scope) {
 *          $scope.items = [ { title:"Dynamic Title 1", content:"Dynamic Item 0" }, {
 *          title:"Dynamic Title 2", content:"Dynamic Item 1", disabled: true } ];
 * 
 * $scope.alertMe = function() { setTimeout(function() { alert("You've selected
 * the alert tab!"); }); }; }; </file> </example>
 */
 ...
 * @restrict EA
 * 
 * @description Creates an HTML heading for a
 *              {@link ui.bootstrap.tabs.directive:tab tab}. Must be placed as
 *              a child of a tab element.
 * 
 * @example <example module="ui.bootstrap"> <file name="index.html">
 *          <uib-tabset> <uib-tab> <uib-tab-heading><b>HTML</b> in my titles?!</tab-heading>
 *          And some content, too! </uib-tab> <uib-tab> <uib-tab-heading><i
 *          class="icon-heart"></i> Icon heading?!?</tab-heading> That's
 *          right. </uib-tab> </uib-tabset> </file> </example>
 */
...
.directive('uibTabHeadingTransclude', function() {
  return {
    restrict: 'A',
    require: ['?^uibTab', '?^tab'], // TODO: change to '^uibTab' after
									// deprecation removal
...
.directive('uibTabContentTransclude', function() {
  return {
    restrict: 'A',
    require: ['?^uibTabset', '?^tabset'], // TODO: change to '^uibTabset'
											// after deprecation removal
  ...
  function isTabHeading(node) {
    return node.tagName && (
      node.hasAttribute('tab-heading') || // TODO: remove after deprecation
											// removal
      node.hasAttribute('data-tab-heading') || // TODO: remove after
												// deprecation removal
      node.hasAttribute('x-tab-heading') || // TODO: remove after deprecation
											// removal
      node.hasAttribute('uib-tab-heading') ||
      node.hasAttribute('data-uib-tab-heading') ||
      node.hasAttribute('x-uib-tab-heading') ||
      node.tagName.toLowerCase() === 'tab-heading' || // TODO: remove after
														// deprecation removal
      node.tagName.toLowerCase() === 'data-tab-heading' || // TODO: remove
															// after deprecation
															// removal
      node.tagName.toLowerCase() === 'x-tab-heading' || // TODO: remove after
														// deprecation removal
 ...
 */
  ...
  .controller('UibTypeaheadController', ['$scope', '$element', '$attrs', '$compile', '$parse', '$q', '$timeout', '$document', '$window', '$rootScope', '$uibPosition', 'uibTypeaheadParser',
    ...
    element.bind('keydown', function(evt) {
      ...
      // if there's nothing selected (i.e. focusFirst) and enter or tab is
		// hit, clear the results
      ...
      modelCtrl.$formatters.push(function(modelValue) {
        ...
        if (inputFormatter) {
          ...
          // it might happen that we don't have enough info to properly render
			// input value
          // we need to check for this situation and simply return model value
			// if we can't apply custom formatting
  ...
  .directive('typeahead', ['$compile', '$parse', '$q', '$timeout', '$document', '$window', '$rootScope', '$uibPosition', 'typeaheadParser', '$log', '$typeaheadSuppressWarning',
    ...
    return {
      ...
      link: function(originalScope, element, attrs, ctrls) {
        ...
        // minimal wait time after last character typed before typeahead
		// kicks-in
        var waitTime = originalScope.$eval(attrs.typeaheadWaitMs) || 0;

        // should it restrict model values to the ones selected from the popup
		// only?
        var isEditable = originalScope.$eval(attrs.typeaheadEditable) !== false;
        ...
        // binding to a variable that indicates if there were no results after
        ...
        // create a child scope for the typeahead directive so we are not
		// polluting original scope
        // with typeahead-specific data (matches, query etc.)
        var scope = originalScope.$new();
        var offDestroy = originalScope.$on('$destroy', function() {
			    scope.$destroy();
        ...
        // Indicate that the specified match is the active (pre-selected) item
		// in the list owned by this typeahead.
        // This attribute is added or removed automatically when the `activeIdx`
		// changes.
        scope.$watch('activeIdx', function(index) {
          if (index < 0) {
        ...
        scope.select = function(activeIdx) {
          ...
          // return focus to the input element if a match was selected via a
			// mouse click event
          // use timeout to avoid $rootScope:inprog error
          if (scope.$eval(attrs.typeaheadFocusOnSelect) !== false) {
            $timeout(function() { element[0].focus(); }, 0, false);
